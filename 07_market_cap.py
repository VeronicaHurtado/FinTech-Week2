...
print(f"Total Numer of Banks: {}")
print(f"Average Market Capitalization: {}")
print(f"Largest Bank: {}")
print(f"Smallest Bank: {}")
print(f"------------------------------------------------")
print(f"Mega Cap Banks: {}")
print(f"Large Cap Banks: {}")
print(f"Mid Cap Banks: {}")
print(f"Small Cap Banks: {}")